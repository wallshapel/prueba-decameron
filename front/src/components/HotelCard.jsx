...
function HotelCard({ hotel }) {
    ...
    return (
        <div className="bg-white shadow-md border border-gray-200 rounded-xl p-6 mb-6">
            ...
            <p className="text-gray-700">NIT: <span className="font-semibold">{hotel.nit}</span></p>
            <p className="text-gray-700 mb-3">Límite de habitaciones: <span className="font-semibold">{hotel.room_limit}</span></p>
